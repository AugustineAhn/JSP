...
/*
	...
	통해 배열로 받아와야하지만, 항목이 하나만 있는 경우에는 아래와 같이 
	처리가 가능하다.
*/
String id_save = request.getParameter("id_save");

//JDBC 연동없이 kosmo/1234일때 로그인 성공
if("kosmo".equals(userid) && "1234".equals(userpw)){
	
	//회원인증이 완료된 경우에 session 영역에 속성 저장
	...
	if(id_save==null){
		...
		ck.setMaxAge(0);//유효시간이 0이므로 사용할 수 없는 쿠키가된다.
	...
	//포워드한 페이지는 리퀘스트영역이 공유되므로 저장한 속성을 읽어올 수 있다.
}
%>
