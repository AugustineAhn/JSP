...
<body>
	...
	<!-- 
	기본값이거나 true일때 HTML이 해석되지 않고 태그까지 그대로
	...
	출력: <c:out value="" default="값이 빈 문자열"></c:out>
	<h4>값이 null인 경우 문자열: 값이 없는 경우에 해당</h4>
	출력: <c:out value="${null }" default="값이 null인 경우"></c:out>
	
	
	<!-- 
		-파라미터로 전달되는 nowPage가 없는 경우에는 1로 표현되고,
		있는 경우는 해당 파라미터값을 가져와서 페이지를 설정한다.
	 -->
	<h3>페이지 링크에 응용하기</h3>
